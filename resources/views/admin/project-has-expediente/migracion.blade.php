  ...
  <div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <a href="{{ url('admin/project-has-expedientes//migracion') }}" class="btn btn-block btn-square btn-lg text-white bg-danger"><i class="fa fa-file-pdf-o"></i> MIGRAR A SOLICITANTES</a>
            </div>
            <div class="form-group col-sm-4">

                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'land_id'">{{ trans('admin.project.columns.count') }}</th>
                                        <!--<th is='sortable' :column="'typology_id'">{{ trans('admin.project.columns.typology_id') }}</th>
                                        <th is='sortable' :column="'action'">{{ trans('admin.project.columns.action') }}</th>
                                        <th is='sortable' :column="'expsocial'">{{ trans('admin.project.columns.expsocial') }}</th>
                                        <th is='sortable' :column="'exptecnico'">{{ trans('admin.project.columns.exptecnico') }}</th>-->
                                ...
                                <tbody>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>@{{ item.postulantes_count }}</td>
                                        <!--<td>@{{ item.typology_id }}</td>
                                        <td>@{{ item.action }}</td>
                                        <td>@{{ item.expsocial }}</td>
                                        <td>@{{ item.exptecnico }}</td>-->

...
class FillPermissionsForProjectHasPostulante extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectHasPostulante constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.project-has-postulante',
            'admin.project-has-postulante.index',
            'admin.project-has-postulante.create',
            'admin.project-has-postulante.show',
            'admin.project-has-postulante.edit',
            'admin.project-has-postulante.delete',
            'admin.project-has-postulante.bulk-delete',
        ]);

...
class FillPermissionsForPostulanteHasDiscapacidad extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPostulanteHasDiscapacidad constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.postulante-has-discapacidad',
            'admin.postulante-has-discapacidad.index',
            'admin.postulante-has-discapacidad.create',
            'admin.postulante-has-discapacidad.show',
            'admin.postulante-has-discapacidad.edit',
            'admin.postulante-has-discapacidad.delete',
            'admin.postulante-has-discapacidad.bulk-delete',
        ]);

...
class FillPermissionsForPostulanteHasBeneficiary extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPostulanteHasBeneficiary constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.postulante-has-beneficiary',
            'admin.postulante-has-beneficiary.index',
            'admin.postulante-has-beneficiary.create',
            'admin.postulante-has-beneficiary.show',
            'admin.postulante-has-beneficiary.edit',
            'admin.postulante-has-beneficiary.delete',
            'admin.postulante-has-beneficiary.bulk-delete',
        ]);
